...
songs_ridges %>%
  ...
  labs(x = "Danceability",
       ...
       subtitle = "Danceability=How suitable a song is for dancing"
  ) + guides(color = FALSE) +
...
songs_ridges %>%
  ...
  labs(x = "Valence",
       ...
       subtitle = "Valence=The positivity or happiness of a song"
       ) +
  guides(color = FALSE) +
  scale_fill_manual(values = c(
    "Very Low" = "#008dfd",
...
songs_ridges %>%
  ...
  labs(x = "Energy",
       ...
       subtitle = "Energy=General itensity and level of activity in a song"
       ) +
  guides(color = FALSE) +
  scale_fill_manual(values = c(
    "Very Low" = "#008dfd",
...
filter(popularity_level %in% c("High", "Very Low")) %>%
  ...
  labs(x = "Speechiness",
       ...
       subtitle = "Speechiness= The amount of spoken (not sung) words in a track"
       ) +
  guides(color = FALSE) +
  scale_fill_manual(values = c(
    "Very Low" = "#008dfd",
...
songs_ridges %>%
  ...
  labs(x = "Acousticness",
       ...
       subtitle = "Acousticness= A measure of how likely the track is to be acoustic"
       ) +
  guides(color = FALSE) +
  scale_fill_manual(values = c(
    "Very Low" = "#008dfd",
...
songs_ridges %>%
  ...
  labs(x = "Duration (s)",
       ...
       subtitle = "Duration= A tracks length in seconds"
       ) +
  guides(color = FALSE) +
  scale_fill_manual(values = c(
    "Very Low" = "#008dfd",
...
songs_ridges %>%
  ...
  labs(x = "Instrumentalness",
       ...
       subtitle = "Instrumentalness=Measure of the lack of singing or words in a track"
       ) +
  guides(color = FALSE) +
  scale_fill_manual(values = c(
    "Very Low" = "#008dfd",
