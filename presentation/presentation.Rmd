...
# Ridge plots continued

```{r,echo=FALSE}
songs_ridges <- rbind(clean_edm, clean_latin, clean_pop, clean_rap, clean_rnb, clean_rock)
```
---
# Valence Ridge Plot
```{r Valence Ridge, echo=FALSE, warning= FALSE}
songs_ridges %>%
  filter(popularity_level == c("High", "Very Low")) %>%
  ggplot(aes(x = valence, y = playlist_genre, fill = popularity_level, color = popularity_level)) +
   geom_density_ridges(alpha = 0.2, bandwidth=0.0571) +
  labs(x = "Valence",
       y = NULL,
       fill = "Popularity Level"
       ) +
...
```{r Energy Ridges, echo=FALSE, warning=FALSE}
songs_ridges %>%
  filter(popularity_level == c("High", "Very Low")) %>%
  ggplot(aes(x = energy, y = playlist_genre, fill = popularity_level, color = popularity_level)) +
   geom_density_ridges(alpha = 0.2, bandwidth= 0.0409) +
  labs(x = "Energy",
       y = NULL,
       fill = "Popularity Level"
       ) +
...
```{r Speechiness Ridge, echo=FALSE,warning=FALSE}
songs_ridges%>%
filter(popularity_level == c("High", "Very Low")) %>%
  ggplot(aes(x = speechiness, y = playlist_genre, fill = popularity_level, color = popularity_level)) +
   geom_density_ridges(alpha = 0.2, bandwidth=0.0159) +
  labs(x = "Speechiness",
       y = NULL,
       fill = "Popularity"
       ) +
...
```{r Acousticness Ridge, echo=FALSE, warning=FALSE}
songs_ridges %>%
  filter(popularity_level == c("High", "Very Low")) %>%
  ggplot(aes(x = acousticness, y = playlist_genre, fill = popularity_level, color = popularity_level)) +
   geom_density_ridges(alpha = 0.2, bandwidth=0.0382) +
  labs(x = "Acousticness",
       y = NULL,
       fill = "Popularity"
       ) +
...
```{r Liveness Ridge, echo=FALSE, warning=FALSE}
songs_ridges %>%
  filter(popularity_level == c("High", "Very Low")) %>%
  ggplot(aes(x = liveness, y = playlist_genre, fill = popularity_level, color = popularity_level)) +
   geom_density_ridges(alpha = 0.2, bandwidth=0.0299) +
  labs(x = "Liveness",
       y = NULL,
       fill = "Popularity"
       ) +
...
```{r Tempo Ridge, echo=FALSE, warning=FALSE}
songs_ridges %>%
  filter(popularity_level == c("High", "Very Low")) %>%
  ggplot(aes(x = tempo, y = playlist_genre, fill = popularity_level, color = popularity_level)) +
   geom_density_ridges(alpha = 0.2, bandwidth=5.82) +
  labs(x = "Tempo (Bpm)",
       y = NULL,
       fill = "Popularity"
       ) +
...
```{r Instrumentalness Ridge, echo=FALSE,warning=FALSE}
songs_ridges %>%
  filter(popularity_level == c("High", "Very Low")) %>%
  ggplot(aes(x = instrumentalness, y = playlist_genre, fill = popularity_level, color = popularity_level)) +
   geom_density_ridges(alpha = 0.2, bandwidth=0.00797) +
...
```{r Multiple Variable analysis part 2, echo=FALSE}
