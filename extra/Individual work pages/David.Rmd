...
```{r}
all_songs <- pop_songs %>%
  rbind(pop_songs, rock_songs, latin_songs, edm_songs, rap_songs, r_and_b_songs)
```
...
all_songs %>%
  ...
  ggplot(aes(x = valence, y = playlist_genre, fill = playlist_genre, color = playlist_genre)) +
...
all_songs %>%
  filter(popularity_level == "High") %>%
  ggplot(aes(x = danceability, y = playlist_genre, fill = playlist_genre, color = playlist_genre)) +
  geom_density_ridges(alpha = 0.5)
```
...
all_songs %>%
  filter(popularity_level == "High") %>%
  ggplot(aes(x = energy, y = playlist_genre, fill = playlist_genre, color = playlist_genre)) +
  geom_density_ridges(alpha = 0.5)
```
...
all_songs %>%
  filter(popularity_level == "High") %>%
  ggplot(aes(x = key, y = playlist_genre, fill = playlist_genre, color = playlist_genre)) +
  geom_density_ridges(alpha = 0.5)
```
...
all_songs %>%
  filter(popularity_level == "High") %>%
  ggplot(aes(x = acousticness, y = playlist_genre, fill = playlist_genre, color = playlist_genre)) +
  geom_density_ridges(alpha = 0.5)
```
...
all_songs %>%
  filter(popularity_level == "High") %>%
  ggplot(aes(x = speechiness, y = playlist_genre, fill = playlist_genre, color = playlist_genre)) +
  geom_density_ridges(alpha = 0.5)
```
...
all_songs %>%
  filter(popularity_level == "High") %>%
  ggplot(aes(x = liveness, y = playlist_genre, fill = playlist_genre, color = playlist_genre)) +
  geom_density_ridges(alpha = 0.5)
```
...
all_songs %>%
  filter(popularity_level == "High") %>%
  ggplot(aes(x = tempo, y = playlist_genre, fill = playlist_genre, color = playlist_genre)) +
  geom_density_ridges(alpha = 0.5)
```
...
all_songs %>%
  filter(popularity_level == "High") %>%
  ggplot(aes(x = instrumentalness, y = playlist_genre, fill = playlist_genre, color = playlist_genre)) +
  geom_density_ridges(alpha = 0.5)
```
